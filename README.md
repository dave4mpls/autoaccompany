...
This is a web program that works with late-model versions of Chrome (mobile or desktop) which have MIDI access.  It allows you to play riffs on your keyboard or other MIDI device, and then it immediately plays them back to layer on top of them to make multi-part improvisational songs.

The software can also work with the built-in MIDI synthesizer in Windows (and maybe Android-- let's see) and allow you to do the riffs using your touch screen or computer keyboard instead of a MIDI keyboard.
